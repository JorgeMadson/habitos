...
- Preserve o fluxo de registro rápido: ação primeiro; objetivo, impacto e contexto são opcionais ou posteriores.
...
- Preserve `entre.entries.v1` até haver uma migração explícita. Importação deve ser idempotente e nunca ressuscitar tombstones.
